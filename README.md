...
## Review
This program writen by Sergey Chernov for tidy data of
Human Activity Recognition Using Smartphones Dataset
Version 1.0

## About program

You should run script run_analysis.R that does the following. 

* Merges the training and the test sets from dir 'UCI HAR Dataset' to create one data set.
* Extracts only the measurements on the mean and standard deviation for each measurement. 
* Uses descriptive activity names to name the activities in the data set
* Appropriately labels the data set with descriptive variable names. 
* From the data set in step 4, creates a second, independent tidy data set with the average of each variable for each activity and each subject.
* Save tidy data set to file `tidyDataSet.txt`  

## Before start

* Download UCI HAR Dataset from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
* Unzip this Dataset
* Setup path dir<-"E://program//TidyDataCourse//UCI HAR Dataset" in first line of `tidyDataSet.txt`  
...
Script for Tidy Data writen by Sergey Chernov. December 2014.
